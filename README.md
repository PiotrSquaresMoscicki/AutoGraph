...
- **Enter** — when a node is selected and the graph pane has focus, create a new node connected from the selected node, select it, and enter rename mode (same as **Tab**).
